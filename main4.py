...
class CircleDetectionApp(App):
    def build(self):
        ...
        self.area_slider = Slider(min=500, max=10000, value=1000)
        self.area_slider.bind(value=lambda instance, value: self.img_widget.set_area(value))
        ...
        control_layout.add_widget(area_label)
        control_layout.add_widget(self.area_slider)
